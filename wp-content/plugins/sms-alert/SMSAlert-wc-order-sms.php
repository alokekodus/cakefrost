...
class smsalert_WC_Order_SMS {
	...
	public function __construct() {
		...
		add_action( 'woocommerce_created_customer', array( 'WooCommerceRegistrationForm', 'wc_user_created' ), 10, 2 );
		add_action( 'smsalert_after_update_new_user_phone', array( 'WooCommerceRegistrationForm', 'smsalert_after_user_register' ), 10, 2 );
