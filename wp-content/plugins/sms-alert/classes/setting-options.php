...
class smsalert_Setting_Options {
	...
	/**
	 * Gets lists of country code with their phone number prefix.
	 */
	public static function get_country_code_dropdown() {
		...
		$sa_countries         = SmsAlertCountryList::getCountryCodeList();
		$countries            = ( ! empty( $sa_countries ) ) ? $sa_countries : array();
	...
	/**
	 * Gets list of countries for multi select option.
	 */
	public static function get_multiple_country_code_dropdown() {
					...
					<div class="SMSAlert_nav_box SMSAlert_nav_callbacks_box callbacks "><!--otp tab-->
								...
								<div id="accordion_10" class="cvt-accordion-body-content" style="height:150px">
									<table class="form-table">
										<tr valign="top">
											...
											<td>
												<?php
													self::get_multiple_country_code_dropdown();
												?>
											</td>
										</tr>
									</table>
						...
						<table class="form-table">
							<tr valign="top">
								...
								<td>
									<?php self::get_country_code_dropdown(); ?>
							...
							<tr valign="top">
								...
								<td class="td-heading">
									...
									?>
									<span class="tooltip" data-title="<?php __( 'Sync users to a Group in smsalert.co.in', 'sms-alert' ); ?>"><span class="dashicons dashicons-info"></span></span>
							...
							<tr valign="top" class="top-border">
								...
								<td class="td-heading">
									<?php
										...
										?>
									<select name="smsalert_general[modal_style]">
							...
							<tr valign="top" class="top-border">
								...
								<input type="checkbox" name="smsalert_reset_settings" id="smsalert_reset_btn" class="SMSAlert_box notify_box hide smsalert_reset" />
									...
									<input type="button" name="smsalert_reset_setting_btn" id="smsalert_reset_settings" class="SMSAlert_box notify_box button button-danger" value="<?php esc_attr_e( 'Reset all Templates & Setiings', 'sms-alert' ); ?>"/>
