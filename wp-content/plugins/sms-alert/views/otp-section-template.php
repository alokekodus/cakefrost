<?php if ( $has_woocommerce || $has_w_p_members || $has_ultimate || $has_w_p_a_m || $has_learn_press ) { ?>
			...
			if ( $has_woocommerce ) {
				...
				<tr valign="top">
					...
					<td scope="row" class="td-heading">
						...
						<input type="checkbox" name="smsalert_general[validate_before_send_otp]" id="smsalert_general[validate_before_send_otp]" class="notify_box" data-parent_id="smsalert_general[buyer_checkout_otp]" <?php echo ( ( 'on' === $validate_before_send_otp ) ? "checked='checked'" : '' ); ?>/><label for="smsalert_general[validate_before_send_otp]"><?php esc_html_e( 'Validate Form Before Sending OTP', 'sms-alert' ); ?></label>
	...
	<table class="form-table">
		...
		<tr valign="top" class="top-border">
			...
			<td colspan="3">
				...
				?>
				<label class="rad_thumb">
				<input type="radio" name="smsalert_general[otp_template_style]" value="otp-popup-1.php" <?php echo ( 'otp-popup-1.php' === $otp_template_style ) ? 'checked="checked"' : ''; ?> class="otp_modal"/>
				<img src="<?php echo esc_url( SA_MOV_URL ); ?>/images/otp-template-1.jpg">
				</label>

				<label class="rad_thumb">
				<input type="radio" name="smsalert_general[otp_template_style]" value="otp-popup-2.php" <?php echo ( 'otp-popup-2.php' === $otp_template_style ) ? 'checked="checked"' : ''; ?> class="otp_modal" />
				<img src="<?php echo esc_url( SA_MOV_URL ); ?>/images/otp-template-2.jpg">
				</label>
			</td>
		</tr>
		<tr valign="top" class="top-border">
		...
		<tr valign="top" class="top-border">
			...
			<div class="smsalert_tokens"><a href="#" data-val="[otp]" style="margin-top:20px">OTP</a> | <a href="#" val="[shop_url]" style="margin-top:20px">Shop Url</a> </div>
			<textarea parent_accordian="otpsection" name="smsalert_message[sms_otp_send]" id="smsalert_message[sms_otp_send]"><?php echo esc_textarea( $sms_otp_send ); ?></textarea>
