...
class ProfileRegistrationForm extends FormInterface {
	...
	/**
	 * Update phone after form registration completes
	 *
	 * @param  array  $data posted data from registration form.
	 * @param  string $form_name form name.
	 * @param  int    $user_id user id.
	 *
	 * @return void
	 */
	public function smsalert_pb_registration_complete( $data, $form_name, $user_id ) {
