...
class ContactForm7 extends FormInterface {
	...
	<tbody>
		<tr>
		<th scope="row"><?php echo __( 'Field type', 'contact-form-7' ); ?></th>
		<td>
			<fieldset>
			<legend class="screen-reader-text"><?php echo __( 'Field type', 'contact-form-7' ); ?></legend>
			<label><input type="checkbox" name="required" checked="checked"/> <?php echo __( 'Required field', 'contact-form-7' ); ?></label>
			</fieldset>
		</td>
		</tr>

		<tr>
		<th scope="row"><label for="<?php echo esc_attr( $args['content'] . '-name' ); ?>"><?php echo __( 'Name', 'contact-form-7' ); ?></label></th>

		<?php
		if ( $type === 'smsalert_otp_input' ) {
		...
		<tr>
			...
			<label><input type="checkbox" name="otp_enabled_popup" class="option" /> <?php echo __( 'Use this field for sending OTP to Mobile Number', 'contact-form-7' ); ?></label>
			<?php } ?>
			</td>
		</tr>
		<tr>
			<th scope="row"><label for="<?php echo esc_attr( $args['content'] . '-values' ); ?>"><?php echo __( 'Default value', 'contact-form-7' ); ?></label></th>
			<td><input type="text" name="values" class="oneline" id="<?php echo esc_attr( $args['content'] . '-values' ); ?>" /><br />
			<label><input type="checkbox" name="placeholder" class="option" /> <?php echo __( 'Use this text as the placeholder of the field', 'contact-form-7' ); ?></label></td>
		</tr>
		<tr>
			<th scope="row"><label for="<?php echo esc_attr( $args['content'] . '-id' ); ?>"><?php echo __( 'Id attribute', 'contact-form-7' ); ?></label></th>
			<td><input type="text" name="id" class="idvalue oneline option" id="<?php echo $args['content'] . '-id'; ?>" /></td>
		</tr>

		<tr>
			<th scope="row"><label for="<?php echo esc_attr( $args['content'] . '-class' ); ?>"><?php echo __( 'Class attribute', 'contact-form-7' ); ?></label></th>
	...
	public function sendsms_c7( $form ) {
		...
		$visitor_number  = '';
		$visitor_message = '';
		if ( ! empty( $options['phoneno'] ) && ! empty( $options['text'] ) ) {
		...
		if ( isset( $options['visitorNumber'] ) && ! empty( $options['visitorNumber'] ) && isset( $options['visitorMessage'] ) && ! empty( $options['visitorMessage'] ) ) {
