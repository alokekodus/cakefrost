<div class="cvt-accordion">
	<div class="accordion-section">
		<a class="cvt-accordion-body-title" href="javascript:void(0)" data-href="#accordion_wc_renewal_cust_0">
			<input type="checkbox" name="smsalert_wc_renewal[customer_notify]" id="smsalert_wc_renewal[customer_notify]" class="notify_box" <?php echo ( 'on' === $templates[0]['enabled'] ) ? "checked='checked'" : ''; ?> /><label><?php esc_attr( $templates[0]['title'] ); ?></label>
			...
			<table class="form-table wc_renewal_sche bottom-border" id="scheduler_<?php echo esc_attr( $count ); ?>">
				...
				<tr valign="top">
					<td colspan="2">
						...
						<textarea name="<?php echo esc_attr( $template['textareaNameId'] ); ?>" id="<?php echo esc_attr( $template['textareaNameId'] ); ?>" data-parent_id="<?php echo esc_attr( $template['checkboxNameId'] ); ?>" <?php echo( ( 'on' === $template['enabled'] ) ? '' : "readonly='readonly'" ); ?>><?php esc_textarea( $template['text-body'] ); ?></textarea>
					</td>
				</tr>
			</table>
			<?php $count++; } ?>
